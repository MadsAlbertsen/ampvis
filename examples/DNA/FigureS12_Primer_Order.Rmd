---
title: "Figure S12 Primer at Order"
...
## Figure S12: Primer coverage at order level
```{r Fig3A_1, fig.align='center', fig.width=6, fig.height=7}
...
```{r save_S12, eval=FALSE}
ggsave("plots/S12_Fig.eps", width = 100, height = 230, units = "mm")
```