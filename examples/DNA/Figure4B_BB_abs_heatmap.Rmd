---
title: "Figure 4B Absolute Beadbeating Heatmap"
...
##Figure 4B: Relative bead beating
```{r Fig4B, fig.align='center', fig.width=3.5, fig.height=2.8}
...
## Save the plot
```{r save, eval=FALSE}
ggsave("plots/Fig4B.eps", width = 90, height = 70, units = "mm")
```