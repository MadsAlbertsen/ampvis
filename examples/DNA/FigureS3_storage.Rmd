...
## Figure S3A: Overall differences between samples using PCA
...
```{r save_S3A, eval=FALSE}
ggsave("plots/S3A.eps", width = 55, height = 55, units = "mm")
```
...
## Figure S3B: Cluster analysis of beta diversity using Bray-Curtis
...
# Figure 3C: Variance compared to time-series data
...
ggsave("plots/S3C.eps", width = 90, height = 55, units = "mm")
```

## Figure 3D: Using clustering to estimate classification resolution
```{r beta_time}
