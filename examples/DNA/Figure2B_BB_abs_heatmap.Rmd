---
title: "Figure 2B Absolute Beadbeating Heatmap"
...
##Figure 2B: Relative bead beating
```{r Fig2B, fig.align='center', fig.width=3.5, fig.height=2.8}
...
## Save the plot
```{r save, eval=FALSE}
ggsave("plots/Fig2B.eps", width = 90, height = 70, units = "mm")
```