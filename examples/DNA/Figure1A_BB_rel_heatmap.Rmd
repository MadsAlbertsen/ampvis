---
title: "Figure 1A Relative Beadbeating Heatmap"
...
## Figure 1A: Relative bead beating
```{r Fig1A, fig.align='center', fig.width=3.5, fig.height=2.8}
...
## Save the plot
```{r save, eval=FALSE}
ggsave("plots/Fig1A.eps", width = 90, height = 70, units = "mm")
```