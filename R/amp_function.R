...
#' @param functions A data frame that associates functions with genus names (default: "MiDAS").
...
#' @param selection A vector with the functions to be displayed e.g. c("FIL","NOB") (default: NULL)
#' 
